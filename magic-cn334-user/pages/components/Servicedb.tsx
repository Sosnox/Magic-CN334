    ...
    return (
        <div className=" flex flex-col bg-emerald-800 rounded-xl h-full text-xl p-5 justify-center items-center">
            ...
            <div className="grid grid-cols-4 justify-center items-center my-5">
                ...
                <div className="flex bg-green-500 mx-4 rounded-md p-2 justify-center">Store</div>
                <div className="flex bg-green-500 mx-4 rounded-md p-2 justify-center">Management</div>
                <div className="flex bg-green-500 mx-4 rounded-md p-2 justify-center">Top Products</div>
            </div>
